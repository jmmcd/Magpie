...
* Assortative mating (re size) versus same
* Threshold on accuracy to avoid too-simple models contributing overly
* LTGE
* How to visualise a large factorial experiment? 
* The validation description is not right
* Need to rethink validation data for opt and for model selection 
* Do proper interval arithmetic based on pyinterval library
* Try again on sympy simplification
