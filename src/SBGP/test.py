...
# use a DataFrame/Series with custom names so we can check that SBGP
...
mr = SBGPRegressor(maxevals=3000, init_prop=0.2,
                     mutprob=0.5,
...
eqs = mr.equations_
print(f"Column names seen by SBGP: {list(mr.column_names_in_)}")
